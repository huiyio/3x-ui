...
[![](https://img.shields.io/github/v/release/huiyio/3x-ui.svg)](https://github.com/huiyio/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/huiyio/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/huiyio/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/huiyio/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/huiyio/3x-ui/master/install.sh)
```
...
```
VERSION=v2.4.5 && bash <(curl -Ls "https://raw.githubusercontent.com/huiyio/3x-ui/$VERSION/install.sh") $VERSION
```
------------
...
wget https://github.com/huiyio/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **克隆项目仓库**
   ...
   ```sh
   git clone https://github.com/huiyio/3x-ui.git
   cd 3x-ui
   ```
